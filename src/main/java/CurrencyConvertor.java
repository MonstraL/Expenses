...
public class CurrencyConvertor {
    ...
    public static double convert(String fromCurrencyCode, String toCurrencyCode) {
        ...
        if ((fromCurrencyCode != null && !fromCurrencyCode.isEmpty())
            ...
            CurrencyConversionResponse response = getResponse(API_PROVDIER+"/latest?access_key=03b07ecb26f5d0dd63f2619fe9cecb77"+"&base="+fromCurrencyCode.substring(fromCurrencyCode.length()-3, fromCurrencyCode.length()));
